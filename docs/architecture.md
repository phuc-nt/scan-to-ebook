...
Stage 1 retry tự động 4 lần trên transient (429, 5xx, timeout, empty content, malformed JSON response) — nâng từ 2 để chịu đợt 429 khi chạy 12 worker song song. Sau retry vẫn fail thì raise exception, count vào failures. Non-transient (403, 400, 401) fail luôn lần đầu — không retry vì là config/auth/quota error, retry vô ích.
